...
const HomePage = () => {
    return(
        <div id="div">
          ...
          <div id="we">
          <div id="id">
           <div><h1 id="contain"><b>Welcome to Vivekanand College!</b></h1>
            <h2 id="h2"><b>Your journey to excellence starts here</b></h2>
                <a href="/admissionpage"><b><button id="me">Apply Now!</button></b></a></div></div>
            ...
            <img src="/Images/college1.jpeg" height="250"width="600"/>
            <img src="/Images/college2.jpg" height="250"width="600"/>
           ...
           <p id="pa">Ready to explore our courses?</p>
                <a href="/coursespage"><button id="me">Explore Courses</button></a>
                </div>
